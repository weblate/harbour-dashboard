...
License:    GPLv3+
BuildArch:  noarch
URL:        https://github.com/ichthyosaurus/harbour-swissmeteo
Source0:    %{name}-%{version}.tar.bz2
Source100:  harbour-swissmeteo.yaml
...
the Federal Office of Meteorology and Climatology (Swiss Meteo). Forecasts are
